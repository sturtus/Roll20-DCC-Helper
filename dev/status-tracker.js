...
on("chat:message", function(msg) {   
    ...
    if (msg.type == "api" && msg.content.indexOf("!StatusClearAll") !== -1  && msg.who.indexOf("(GM)") {
...
on("chat:message", function(msg) {   
    ...
    if (msg.type == "api" && msg.content.indexOf("!StatusAdd ") !== -1) {
...
on("chat:message", function(msg) {   
    ...
    if (msg.type == "api" && msg.content.indexOf("!StatusDel ") !== -1) {
