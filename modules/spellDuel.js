...
a script to handle the spell duel mechanic of DCC. 
In DCC, when a spellcaster casts a spell, any other spellcaster can attempt to counter that spell instantaneously with a counterspell. 
the initial spellcaster in this case is known as the Attacker and the counter spellcaster(s) is the Defender(s). 

the Attacker and the Defender track a new attribute called Momentum which tracks the duel's winner
